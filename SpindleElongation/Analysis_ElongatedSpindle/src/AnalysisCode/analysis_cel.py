...
def main():
    ...
    data_path = os.path.join(
         '../../../')
    fixed_path = os.path.join(data_path, 'Analysis_ElongatedSpindle/Result/Simulation/Cel_MTFixed.csv')
    variable_path = os.path.join(data_path,
                                 'Analysis_ElongatedSpindle/Result/Simulation/Cel_MTVariable.csv')
    ...
    if args.experiment:
        exp_data1 = experiment[experiment['name'].str.contains('TH27_')
                               | experiment['name'].str.contains('TH32_17')]
        exp_data2 = experiment[experiment['name'].str.contains('dpy-11')
                               | experiment['name'].str.contains('DPY11')]
        exp_data3 = experiment[experiment['name'].str.contains('C27D9.1')]
        exp_data4 = experiment[experiment['name'].str.contains('CAL1628')
