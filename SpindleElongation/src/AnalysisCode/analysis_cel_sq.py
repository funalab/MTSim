...
def main():
    ...
    fixed_path = os.path.join(data_path, "Result/Simulation/Cel_MTVariable.csv")
    variable_path = os.path.join(data_path, "Result/Simulation/Cel_led_MTVariable.csv")
    ...
    plt.tight_layout()
    plt.savefig("../../Result/Analysis/Cel_sim_vs_exp_led.pdf")
