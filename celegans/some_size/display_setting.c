...
void display_setting(mtGraphics *mtg) {
  ...
  XDrawArc(d,mtg->w2,mtg->gc2,WIN_WIDTH/2-(int)(Scale1*Cir_Rad*pow(10,6)), WIN_HEIGHT/2-(int)(Scale1*Cir_Rad*pow(10,6)), (int)(2*Scale1*Cir_Rad*pow(10,6)), (int)(2*Scale1*Cir_Rad*pow(10,6)), 0, 360*64);
  ...
  XDrawLine(d,mtg->w3,mtg->gc3,(int)(SC3*ST),WIN_HEIGHT,(int)(SC3*ST),WIN_HEIGHT-5);
  XDrawLine(d,mtg->w3,mtg->gc3,(int)(SC3*ST*1/4),WIN_HEIGHT,(int)(SC3*ST*1/4),WIN_HEIGHT-5); 
  XDrawLine(d,mtg->w3,mtg->gc3,(int)(SC3*ST*2/4),WIN_HEIGHT,(int)(SC3*ST*2/4),WIN_HEIGHT-5); 
  XDrawLine(d,mtg->w3,mtg->gc3,(int)(SC3*ST*3/4),WIN_HEIGHT,(int)(SC3*ST*3/4),WIN_HEIGHT-5); 
  ...
  XDrawLine(d,mtg->w4,mtg->gc4,(int)(SC3*ST),WIN_HEIGHT,(int)(SC3*ST),WIN_HEIGHT-5);
  XDrawLine(d,mtg->w4,mtg->gc4,(int)(SC3*ST/2),WIN_HEIGHT,(int)(SC3*ST/2),WIN_HEIGHT-5);
  XDrawLine(d,mtg->w4,mtg->gc4,(int)(SC3*ST*3/4),WIN_HEIGHT,(int)(SC3*ST*3/4),WIN_HEIGHT-5);
  XDrawLine(d,mtg->w4,mtg->gc4,(int)(SC3*ST/4),WIN_HEIGHT,(int)(SC3*ST/4),WIN_HEIGHT-5);
  /* inset */
  /**/
  ...
  XDrawLine(d,mtg->w4,mtg->gc4,0,WIN_HEIGHT-(int)(Scale1*25),(int)(SC3*ST),WIN_HEIGHT-(int)(Scale1*25));
  ...
  XDrawLine(d,mtg->w5,mtg->gc5,(int)(SC3*ST),WIN_HEIGHT,(int)(SC3*ST),WIN_HEIGHT-5);
  XDrawLine(d,mtg->w5,mtg->gc5,(int)(SC3*ST/4),WIN_HEIGHT,(int)(SC3*ST/4),WIN_HEIGHT-5);
  XDrawLine(d,mtg->w5,mtg->gc5,(int)(SC3*ST/2),WIN_HEIGHT,(int)(SC3*ST/2),WIN_HEIGHT-5);
  XDrawLine(d,mtg->w5,mtg->gc5,(int)(SC3*ST*3/4),WIN_HEIGHT,(int)(SC3*ST*3/4),WIN_HEIGHT-5);
  ...
  XDrawLine(d,mtg->w6,mtg->gc6,(int)(SC3*ST),WIN_HEIGHT,(int)(SC3*ST),WIN_HEIGHT-5);
  XDrawLine(d,mtg->w6,mtg->gc6,(int)(SC3*ST/4),WIN_HEIGHT,(int)(SC3*ST/4),WIN_HEIGHT-5);
  XDrawLine(d,mtg->w6,mtg->gc6,(int)(SC3*ST/2),WIN_HEIGHT,(int)(SC3*ST/2),WIN_HEIGHT-5);
  XDrawLine(d,mtg->w6,mtg->gc6,(int)(SC3*ST*3/4),WIN_HEIGHT,(int)(SC3*ST*3/4),WIN_HEIGHT-5);
  ...
  XDrawLine(d,mtg->w7,mtg->gc7,(int)(SC3*ST),WIN_HEIGHT,(int)(SC3*ST),WIN_HEIGHT-5);
  XDrawLine(d,mtg->w7,mtg->gc7,(int)(SC3*ST/2),WIN_HEIGHT,(int)(SC3*ST/2),WIN_HEIGHT-5);
  XDrawLine(d,mtg->w7,mtg->gc7,(int)(SC3*ST*3/4),WIN_HEIGHT,(int)(SC3*ST*3/4),WIN_HEIGHT-5);
  XDrawLine(d,mtg->w7,mtg->gc7,(int)(SC3*ST/4),WIN_HEIGHT,(int)(SC3*ST/4),WIN_HEIGHT-5);
  XSetLineAttributes (d,mtg->gc7,1,LineOnOffDash, CapButt, JoinMiter);
  XDrawLine(d,mtg->w7,mtg->gc7,0,WIN_HEIGHT-(int)(Scale1*25),(int)(SC3*ST),WIN_HEIGHT-(int)(Scale1*25));
  XDrawLine(d,mtg->w7,mtg->gc7,0,WIN_HEIGHT-(int)(Scale1*50),(int)(SC3*ST),WIN_HEIGHT-(int)(Scale1*50));
  ...
  XDrawLine(d,mtg->w8,mtg->gc8,(int)(SC3*ST),WIN_HEIGHT,(int)(SC3*ST),WIN_HEIGHT-5);
  XDrawLine(d,mtg->w8,mtg->gc8,(int)(SC3*ST/2),WIN_HEIGHT,(int)(SC3*ST/2),WIN_HEIGHT-5);
  XDrawLine(d,mtg->w8,mtg->gc8,(int)(SC3*ST*3/4),WIN_HEIGHT,(int)(SC3*ST*3/4),WIN_HEIGHT-5);
  XDrawLine(d,mtg->w8,mtg->gc8,(int)(SC3*ST/4),WIN_HEIGHT,(int)(SC3*ST/4),WIN_HEIGHT-5);
