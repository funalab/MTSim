 ...
 * Last modified: Wed, 20 Jul 2022 01:51:20 +0900
 */
...
int main(int argc, char* argv[]) {
  ...
  *idum = tt*(-1);
  ...
  double starting_degree = 0; /* starting degree of aster: for the simulation with single aster (Sup Fig S9) this value should be changed*/
